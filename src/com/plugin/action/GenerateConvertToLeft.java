...
/**
 * 生成要转换另一个类的的build和set语句语句（不会识别是否同名属性，输入当前要转换的类的定义）
 *
 * @author 沈钦林
 * @date 2023/9/28 17:13
 */
public class GenerateConvertToLeft extends AnAction {
    @Override
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        JFrame frame = new JFrame("生成要转换另一个类的的build和set语句语句（不会识别是否同名属性，输入当前要转换的类的定义）");
        ...
        pulginInputForm.confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Result<List<String>> result = generateController.generateConvertToLeft(generateRequestDTO);
