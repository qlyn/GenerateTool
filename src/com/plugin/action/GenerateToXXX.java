...
/**
 * 生成当前转化另一个类的方法（输入当前要转换的类的定义，会识别是否同名属性即只转化同名属性）
 *
 * @author 沈钦林
 * @date 2023/9/28 17:40
 */
public class GenerateToXXX extends AnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        JFrame frame = new JFrame("生成当前转化另一个类的方法（输入当前要转换的类的定义，会识别是否同名属性即只转化同名属性）");
        ...
        pulginInputForm.confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Result<List<String>> result = generateController.generateToXXX(generateRequestDTO);
